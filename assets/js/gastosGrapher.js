...
function dibujarD3_ing() {
  $.getJSON("https://sheets.googleapis.com/v4/spreadsheets/1rTgnsUT61UBR8akjjOT2Vl8viEgCrWCEKoRwZauVw9I/values/2020/?key="+apiKey, function(dataJSON) {
    $("#ingresosGraph").empty();
    var datos = [];
    var detalle = [];
    ...
    $.each(dataJSON.values, function(key, val) {
      if (key > 0) {
        ...
        var nivel = val[0]; //partida_splited.length;
